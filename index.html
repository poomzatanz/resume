    ...
    <div class="navbar navbar-fixed-top custom-navbar" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a href="#" class="navbar-brand">Raksit Kongwong</a>
            </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="home-thumb">
                        <div class="section-title">
                            ...
                            <h1 class="wow fadeInUp" data-wow-delay="0.6s">Hello, I've just graduated . I am <strong>Raksit Kongwong</strong> My nickname is <strong>Poom</strong>. I live in Thailand </h1>
            ...
            <div class="row">
                    ...
                    <div class="about-thumb">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.6s">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>My Full Name : Raksit Kongwong</th>
                                        <th>My Nickname : Poom</th>
                                        <th>My Age : 23 year old</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <th>My Facebook : <a href="https://www.facebook.com/PoomRaksit">Click it</a></th>
                                        <th>My Line : poomkubnn</th>
                                        <th>My Email : raksit.kongwong@gmail.com</th>
                                    </tr>
                                    <tr>
                                        <th>My GitHub : <a href="https://github.com/poomzatanz">Click it</a></th>
                                        <th>My Telephone Number : +6683-0494149</th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="wow fadeInUp" data-wow-delay="0.8s">
                            <p> My hobbies are reading psychology novels and books. Play the Internet, check the news </p>
                            <p>I am very straight forward. If someone asked to look at various events I will give a straightforward introduction to the work, there may be some impact on the field of analysis.I am very straight forward. If someone asked to
                                look at various events I will give a straightforward introduction to the work, there may be some impact on the field of analysis..</p>
                            <p>I am a person who dares to trial and error when I get a job. If today's news is updated with new software and suitable for our work I will try to test immediately. I couldn't have said each other again. But at least have experience
                                with that software</p>
                            <p>I am a person who likes challenges. If there is a difficult job coming I'm not going to deny it, but I would say, let's do some research and do it first. How could you not say that again?</p>
                            <p>I am a skeptic about everything in the real room, full of books, which I always put in my mind for new knowledge, both on books and on the Internet.</p>
                            <p>I never gave up if I suddenly said The deadline is tomorrow. I will react to the rainbow on the screen and not rest until the work is finished.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-yellow col-md-3 col-sm-6">
                    <div class="skill-thumb">
                        ...
                        <p class="color-white">Codeing Skill</p>
                        <div class=" wow fadeInUp skills-thumb" data-wow-delay="1.6s">
                            ...
                            <strong>Matchine Learning</strong>
                            <span class="color-white pull-right">60%</span>
                            <div class="progress">
                                <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;"></div>
                            </div>
                            ...
                            <p class="color-white">Language Skill</p>
                            <div class=" wow fadeInUp skills-thumb" data-wow-delay="1.6s">
                    ...
                    <div class="color-white experience-thumb">
                        ...
                        <div class="wow fadeInUp color-white media" data-wow-delay="1.2s">
                            ...
                            <div class="media-body">
                                <h3 class="media-heading">Internship Web programmer <small>2019 April - 2019 June</small></h3>
                                <p class="color-white">BANGKOK WEB SOLUTION</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="color-white education-thumb">
                        ...
                        <div class="wow fadeInUp color-white media" data-wow-delay="1.2s">
                            ...
                            <div class="media-body">
                                <h3 class="media-heading">High School <small>2010 May - 2016 March</small></h3>
                                <p class="color-white">Phanom Sarakham Phanom Adun Witthaya School</p>
                            </div>
                        </div>
                        ...
                        <div class="wow fadeInUp color-white media" data-wow-delay="1.6s">
                            ...
                            <div class="media-body">
                                <h3 class="media-heading">Bachelor of Technology <small>2016 August - 2021 May</small></h3>
                                <p class="color-white">King Mongkut's University of Technology Thonburi</p>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-10 col-sm-12">
                    ...
                    <h2 class="wow fadeInUp" data-wow-delay="0.8s">Thanks for your visit</h2>
                </div>
                ...
                <div class="bg-dark col-md-3 col-sm-6">
                    <div class="contact-thumb">
                        ...
                        <div class="wow fadeInUp contact-info" data-wow-delay="0.8s">
                            ...
                            <p><i class="fa fa-phone"></i> 08-3049-4149</p>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="wow fadeInUp footer-copyright" data-wow-delay="1.8s">
                        <p>Copyright &copy; 2016 Your Company | Design: TemplateMo</p>
                    </div>
                    <ul class="wow fadeInUp social-icon" data-wow-delay="2s">
                        <li>
                            <a href="https://www.facebook.com/PoomRaksit" class="fa fa-facebook"></a>
                        </li>
                        <li>
                            <a href="https://github.com/poomzatanz" class="fa fa-github"></a>
                        </li>

                        <li>
                            <a href="https://www.linkedin.com/in/raksit-kongwong-586396207/" class="fa fa-linkedin"></a>
                        </li>
                    </ul>
                </div>
